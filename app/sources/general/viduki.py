...
class VidukiScraper(Scraper):
    def __init__(self):
        super().__init__(source="viduki", base_url="https://www.viduki.net",
                        #  headless=False
                         )
